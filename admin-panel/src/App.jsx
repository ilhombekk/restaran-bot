...
const TRANSLATIONS = {
  ...
  cy: {
    ...
    pickup: "Ўзи олиб кетади", delivery: "Етказиб бериш",
    ...
    subtitle: "Буюртмалар, маҳсулотлар ва тўловлар реал маълумотлар билан ишлаяпти.",
    enable_notif: "Хабарномаларни ёқиш", notif_enabled: "Хабарномалар ёқилган",
    search: "Қидириш...", change: "Ўзгартириш",
    today_orders: "Бугунги буюртмалар", today_helper: "Бугун тушган",
    new_orders: "Янги", new_helper: "Бугунги янгилар",
    delivered_orders: "Етказилган", delivered_helper: "Бугун етказилган",
    paid_orders: "Тўланган", paid_helper: "Бугун тўланган",
    pending_orders: "Тўлов кутилмоқда", pending_helper: "Click кутилмоқда",
    cancelled_orders: "Бекор қилинган", cancelled_helper: "Бугун бекор",
    revenue_today: "Бугунги умумий тушум",
    last_orders: "Сўнгги буюртмалар", last_orders_sub: "Охирги 3 та буюртма",
    ...
    confirm_delete_order: "Ростдан ҳам бу буюртмани ўчирмоқчимисиз?",
    confirm_clear_history: (n) => `Барча ${n} та тарих буюртмасини ўчирасизми?`,
    per_page: (n) => `Ҳар саҳифада ${n} та буюртма`,
    cat_order: "Категория тартиби", cat_order_sub: "Менюдаги кўриниш тартиби",
    ...
    all_stats: "Умумий статистика", all_stats_sub: "Барча вақтдаги маълумотлар",
    ...
    daily_stats: "Ҳар кунлик статистика", daily_stats_sub: "Кунлар бўйича тушум ва заказлар",
    ...
    url_btn: "URL билан", upload_btn: "Юклаш",
    img_url_placeholder: "Расм URL", img_preview: "Расм preview",
    cancel: "Бекор қилиш",
    ...
    no_time: "Вақт йўқ", no_date: "Сана йўқ",
